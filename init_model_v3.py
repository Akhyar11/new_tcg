...
def main():
    print("=== Initialize Model v3 with Knowledge Distillation ===")
    ...
    print(f"Saving initialized model to {model_path}...")
    with open(model_path, "wb") as f:
        f.write(serialization.to_bytes(final_params))
        
    print("\nUploading initialized model to Kaggle...")
    upload_to_kaggle(checkpoints_dir, message="Initial upload model_ptr_v3 with Teacher KD")
    print("\nDone! Model v3 is ready for training.")
