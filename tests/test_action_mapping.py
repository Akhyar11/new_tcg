...
from tcg_core.action_mapping import (
    ...
    PLAY_START, CARD_DECK_START, ATTACK_START, ACTION_END
)
...
def test_action_mapping():
    ...
    # Opsi 3: Pilih kartu Deck indeks 12 (OptionType.CARD, area=DECK)
    select_data_mock = {
        "options": [
            {"type": "PLAY", "index": 5},
            {"type": "ATTACK", "index": 1},
            {"type": "END", "index": 0},
            {"type": "CARD", "index": 12, "area": "DECK"}
        ]
    }
    ...
    print(f"Apakah mask CARD_DECK_START+12 ({CARD_DECK_START+12}) menyala? {mask[CARD_DECK_START+12] == 1.0}")
    ...
    # Anggaplah JAX Model AI (PPO) memprediksi dan memilih aksi `ATTACK_START + 1`
    ...
    # Anggaplah JAX memilih `ACTION_END`
