...
def main():
    ...
    print("=== TCG LSTM VS PTR GAMEPLAY ANALYSIS ===")
    print(f"Deck: Mega Charizard Y Sniper (1v1 LSTM vs PTR)")
    ...
    agent_p0 = LSTMAgent("LSTM_P0", LSTMModel, action_mapping, lstm_model_path if os.path.exists(lstm_model_path) else None)
